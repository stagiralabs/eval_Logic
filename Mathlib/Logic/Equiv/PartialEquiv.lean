...
@[target] theorem coe_symm_mk (f : α → β) (g s t ml mr il ir) :
    ((PartialEquiv.mk f g s t ml mr il ir).symm : β → α) = g := by sorry

@[target] theorem invFun_as_coe : e.invFun = e.symm := by sorry

@[target] theorem map_source {x : α} (h : x ∈ e.source) : e x ∈ e.target := by sorry

lemma map_source'' : e '' e.source ⊆ e.target :=
  fun _ ⟨_, hx, hex⟩ ↦ mem_of_eq_of_mem (id hex.symm) (e.map_source' hx)

@[target] theorem map_target {x : β} (h : x ∈ e.target) : e.symm x ∈ e.source := by sorry

@[target] theorem left_inv {x : α} (h : x ∈ e.source) : e.symm (e x) = x := by sorry

@[target] theorem right_inv {x : β} (h : x ∈ e.target) : e (e.symm x) = x := by sorry
...
@[target] theorem symm_mapsTo : MapsTo e.symm e.target e.source := by sorry
...
@[target] theorem copy_eq (e : PartialEquiv α β) (f : α → β) (hf : ⇑e = f) (g : β → α) (hg : ⇑e.symm = g)
    (s : Set α) (hs : e.source = s) (t : Set β) (ht : e.target = t) :
    e.copy f hf g hg s hs t ht = e := by sorry

@[target] theorem symm_source : e.symm.source = e.target := by sorry

@[target] theorem symm_target : e.symm.target = e.source := by sorry

@[target] theorem symm_symm : e.symm.symm = e := by sorry
...
@[target] theorem forall_mem_target {p : β → Prop} : (∀ y ∈ e.target, p y) ↔ ∀ x ∈ e.source, p (e x) := by sorry

@[target] theorem exists_mem_target {p : β → Prop} : (∃ y ∈ e.target, p y) ↔ ∃ x ∈ e.source, p (e x) := by sorry
...
@[target] theorem apply_mem_iff (h : e.IsImage s t) (hx : x ∈ e.source) : e x ∈ t ↔ x ∈ s := by sorry

@[target] theorem symm_apply_mem_iff (h : e.IsImage s t) : ∀ ⦃y⦄, y ∈ e.target → (e.symm y ∈ s ↔ y ∈ t) := by sorry
...
@[target] theorem image_eq (h : e.IsImage s t) : e '' (e.source ∩ s) = e.target ∩ t := by sorry

@[target] theorem symm_image_eq (h : e.IsImage s t) : e.symm '' (e.target ∩ t) = e.source ∩ s := by sorry
...
@[target] theorem leftInvOn_piecewise {e' : PartialEquiv α β} [∀ i, Decidable (i ∈ s)]
    [∀ i, Decidable (i ∈ t)] (h : e.IsImage s t) (h' : e'.IsImage s t) :
    LeftInvOn (t.piecewise e.symm e'.symm) (s.piecewise e e') (s.ite e.source e'.source) := by sorry
...
@[target] theorem symm_eq_on_of_inter_eq_of_eqOn {e' : PartialEquiv α β} (h : e.IsImage s t)
    (hs : e.source ∩ s = e'.source ∩ s) (heq : EqOn e e' (e.source ∩ s)) :
    EqOn e.symm e'.symm (e.target ∩ t) := by sorry

end IsImage

@[target] theorem isImage_source_target : e.IsImage e.source e.target := by sorry

@[target] theorem isImage_source_target_of_disjoint (e' : PartialEquiv α β) (hs : Disjoint e.source e'.source)
    (ht : Disjoint e.target e'.target) : e.IsImage e'.source e'.target := by sorry

@[target] theorem image_source_inter_eq' (s : Set α) : e '' (e.source ∩ s) = e.target ∩ e.symm ⁻¹' s := by sorry
...
@[target] theorem image_eq_target_inter_inv_preimage {s : Set α} (h : s ⊆ e.source) :
    e '' s = e.target ∩ e.symm ⁻¹' s := by sorry

@[target] theorem symm_image_eq_source_inter_preimage {s : Set β} (h : s ⊆ e.target) :
    e.symm '' s = e.source ∩ e ⁻¹' s := by sorry

@[target] theorem symm_image_target_inter_eq (s : Set β) :
    e.symm '' (e.target ∩ s) = e.source ∩ e ⁻¹' (e.target ∩ s) := by sorry
...
@[target] theorem target_inter_inv_preimage_preimage (s : Set β) :
    e.target ∩ e.symm ⁻¹' (e ⁻¹' s) = e.target ∩ s := by sorry

theorem symm_image_image_of_subset_source {s : Set α} (h : s ⊆ e.source) : e.symm '' (e '' s) = s :=
  (e.leftInvOn.mono h).image_image

@[target] theorem image_symm_image_of_subset_target {s : Set β} (h : s ⊆ e.target) : e '' (e.symm '' s) = s := by sorry

@[target] theorem source_subset_preimage_target : e.source ⊆ e ⁻¹' e.target := by sorry

@[target] theorem symm_image_target_eq_source : e.symm '' e.target = e.source := by sorry

@[target] theorem target_subset_preimage_source : e.target ⊆ e.symm ⁻¹' e.source := by sorry
...
@[target] theorem restr_coe (s : Set α) : (e.restr s : α → β) = e := by sorry

@[target] theorem restr_coe_symm (s : Set α) : ((e.restr s).symm : β → α) = e.symm := by sorry

@[target] theorem restr_source (s : Set α) : (e.restr s).source = e.source ∩ s := by sorry

@[target] theorem source_restr_subset_source (s : Set α) : (e.restr s).source ⊆ e.source := by sorry

@[target] theorem restr_target (s : Set α) : (e.restr s).target = e.target ∩ e.symm ⁻¹' s := by sorry

@[target] theorem restr_eq_of_source_subset {e : PartialEquiv α β} {s : Set α} (h : e.source ⊆ s) :
    e.restr s = e := by sorry

@[target] theorem restr_univ {e : PartialEquiv α β} : e.restr univ = e := by sorry

@[target] theorem refl_source : (PartialEquiv.refl α).source = univ := by sorry

@[target] theorem refl_target : (PartialEquiv.refl α).target = univ := by sorry

@[target] theorem refl_coe : (PartialEquiv.refl α : α → α) = id := by sorry

@[target] theorem refl_symm : (PartialEquiv.refl α).symm = PartialEquiv.refl α := by sorry

@[target] theorem refl_restr_source (s : Set α) : ((PartialEquiv.refl α).restr s).source = s := by sorry

@[target] theorem refl_restr_target (s : Set α) : ((PartialEquiv.refl α).restr s).target = s := by sorry
...
@[target] theorem ofSet_target (s : Set α) : (PartialEquiv.ofSet s).target = s := by sorry

@[target] theorem ofSet_coe (s : Set α) : (PartialEquiv.ofSet s : α → α) = id := by sorry

@[target] theorem ofSet_symm (s : Set α) : (PartialEquiv.ofSet s).symm = PartialEquiv.ofSet s := by sorry
...
@[target] theorem trans_apply {x : α} : (e.trans e') x = e' (e x) := by sorry

@[target] theorem trans_symm_eq_symm_trans_symm : (e.trans e').symm = e'.symm.trans e.symm := by sorry

@[target] theorem trans_source : (e.trans e').source = e.source ∩ e ⁻¹' e'.source := by sorry
...
@[target] theorem image_trans_source : e '' (e.trans e').source = e.target ∩ e'.source := by sorry
...
@[target] theorem trans_assoc (e'' : PartialEquiv γ δ) : (e.trans e').trans e'' = e.trans (e'.trans e'') := by sorry

@[simp, mfld_simps]
theorem trans_refl : e.trans (PartialEquiv.refl β) = e :=
  PartialEquiv.ext (fun _ => rfl) (fun _ => rfl) (by simp [trans_source])

@[target] theorem refl_trans : (PartialEquiv.refl α).trans e = e := by sorry

@[target] theorem trans_ofSet (s : Set β) : e.trans (ofSet s) = e.restr (e ⁻¹' s) := by sorry

@[target] theorem trans_refl_restr (s : Set β) :
    e.trans ((PartialEquiv.refl β).restr s) = e.restr (e ⁻¹' s) := by sorry
...
@[target] theorem restr_trans (s : Set α) : (e.restr s).trans e' = (e.trans e').restr s := by sorry

@[target] theorem mem_symm_trans_source {e' : PartialEquiv α γ} {x : α} (he : x ∈ e.source)
    (he' : x ∈ e'.source) : e x ∈ (e.symm.trans e').source := by sorry
...
@[target] theorem eqOnSource_refl : e ≈ e := by sorry

@[target] theorem EqOnSource.source_eq {e e' : PartialEquiv α β} (h : e ≈ e') : e.source = e'.source := by sorry
...
@[target] theorem symm_trans_self : e.symm.trans e ≈ ofSet e.target := by sorry

@[target] theorem eq_of_eqOnSource_univ (e e' : PartialEquiv α β) (h : e ≈ e') (s : e.source = univ)
    (t : e.target = univ) : e = e' := by sorry
...
@[target] theorem prod_source (e : PartialEquiv α β) (e' : PartialEquiv γ δ) :
    (e.prod e').source = e.source ×ˢ e'.source := by sorry

@[target] theorem prod_target (e : PartialEquiv α β) (e' : PartialEquiv γ δ) :
    (e.prod e').target = e.target ×ˢ e'.target := by sorry

@[target] theorem prod_coe (e : PartialEquiv α β) (e' : PartialEquiv γ δ) :
    (e.prod e' : α × γ → β × δ) = fun p => (e p.1, e' p.2) := by sorry

@[target] theorem prod_coe_symm (e : PartialEquiv α β) (e' : PartialEquiv γ δ) :
    ((e.prod e').symm : β × δ → α × γ) = fun p => (e.symm p.1, e'.symm p.2) := by sorry
...
@[target] theorem prod_trans {η : Type*} {ε : Type*} (e : PartialEquiv α β) (f : PartialEquiv β γ)
    (e' : PartialEquiv δ η) (f' : PartialEquiv η ε) :
    (e.prod e').trans (f.prod f') = (e.trans f).prod (e'.trans f') := by sorry
...
@[target] theorem symm_piecewise (e e' : PartialEquiv α β) {s : Set α} {t : Set β} [∀ x, Decidable (x ∈ s)]
    [∀ y, Decidable (y ∈ t)] (H : e.IsImage s t) (H' : e'.IsImage s t) :
    (e.piecewise e' s t H H').symm = e.symm.piecewise e'.symm t s H.symm H'.symm := by sorry
...
@[target] theorem disjointUnion_eq_piecewise (e e' : PartialEquiv α β) (hs : Disjoint e.source e'.source)
    (ht : Disjoint e.target e'.target) [∀ x, Decidable (x ∈ e.source)]
    [∀ y, Decidable (y ∈ e.target)] :
    e.disjointUnion e' hs ht =
      e.piecewise e' e.source e.target e.isImage_source_target
        (e'.isImage_source_target_of_disjoint _ hs.symm ht.symm) := by sorry
...
@[target] theorem pi_symm (ei : ∀ i, PartialEquiv (αi i) (βi i)) :
    (PartialEquiv.pi ei).symm = .pi fun i ↦ (ei i).symm := by sorry

@[target] theorem pi_symm_apply (ei : ∀ i, PartialEquiv (αi i) (βi i)) :
    ⇑(PartialEquiv.pi ei).symm = fun f i ↦ (ei i).symm (f i) := by sorry

@[target] theorem pi_refl : (PartialEquiv.pi fun i ↦ PartialEquiv.refl (αi i)) = .refl (∀ i, αi i) := by sorry

@[target] theorem pi_trans (ei : ∀ i, PartialEquiv (αi i) (βi i)) (ei' : ∀ i, PartialEquiv (βi i) (γi i)) :
    (PartialEquiv.pi ei).trans (PartialEquiv.pi ei') = .pi fun i ↦ (ei i).trans (ei' i) := by sorry
...
@[target] theorem refl_toPartialEquiv : (Equiv.refl α).toPartialEquiv = PartialEquiv.refl α := by sorry

@[simp, mfld_simps]
theorem symm_toPartialEquiv : e.symm.toPartialEquiv = e.toPartialEquiv.symm :=
  rfl

@[target] theorem trans_toPartialEquiv :
    (e.trans e').toPartialEquiv = e.toPartialEquiv.trans e'.toPartialEquiv := by sorry
...
@[target] theorem transPartialEquiv_trans (e : α ≃ β) (f' : PartialEquiv β γ) (f'' : PartialEquiv γ δ) :
    (e.transPartialEquiv f').trans f'' = e.transPartialEquiv (f'.trans f'') := by sorry

@[target] theorem trans_transPartialEquiv (e : α ≃ β) (e' : β ≃ γ) (f'' : PartialEquiv γ δ) :
    (e.trans e').transPartialEquiv f'' = e.transPartialEquiv (e'.transPartialEquiv f'') := by sorry
...
@[target] theorem transEquiv_eq_trans (e : PartialEquiv α β) (e' : β ≃ γ) :
    e.transEquiv e' = e.trans e'.toPartialEquiv := by sorry

@[target] theorem transEquiv_transEquiv (e : PartialEquiv α β) (f' : β ≃ γ) (f'' : γ ≃ δ) :
    (e.transEquiv f').transEquiv f'' = e.transEquiv (f'.trans f'') := by sorry

@[target] theorem trans_transEquiv (e : PartialEquiv α β) (e' : PartialEquiv β γ) (f'' : γ ≃ δ) :
    (e.trans e').transEquiv f'' = e.trans (e'.transEquiv f'') := by sorry
