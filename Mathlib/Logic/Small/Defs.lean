...
-/
@[target] theorem Small.mk' {α : Type v} {S : Type w} (e : α ≃ S) : Small.{w} α := by sorry
...
@[target] theorem Shrink.ext {α : Type v} [Small.{w} α] {x y : Shrink α}
    (w : (equivShrink _).symm x = (equivShrink _).symm y) : x = y := by sorry
...
@[target] theorem small_map {α : Type*} {β : Type*} [hβ : Small.{w} β] (e : α ≃ β) : Small.{w} α := by sorry
...
@[target] theorem small_congr {α : Type*} {β : Type*} (e : α ≃ β) : Small.{w} α ↔ Small.{w} β := by sorry
